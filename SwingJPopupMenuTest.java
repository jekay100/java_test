/**
 * @file Name: SwingJPopupMenuTest.java
 * @description:Test the SwingJPopupMenuTest class
 * @author : trilever
 * @version : 1.0
...
public class SwingJPopupMenuTest
{
	public static void main(String[] args) throws Exception
	{
		...
		jpm.add(Thin);
		jta.add(jpm);
		//add the popmenu onto the Textarea
		jta.setComponentPopupMenu(jpm);
		Bold.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e)
		{
			//if()jta.setFont(new Font("1",Font.BOLD,25));
